    ...
    partial class Weapons
    {
        WeaponDefinition DualLargeGatlingTurret_KL_Turret1 => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDefinition
            {
                ...
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, rotateRate: 0.02f, elevateRate: 0.02f, minAzimuth: -180, maxAzimuth: 2, minElevation: -20, maxElevation: 80, offset: Vector(x: 0, y: -.12, z: 0), fixedOffset: false, debug: true),
